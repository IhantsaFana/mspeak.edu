...
<div class="mt-3">
      ...
      <div class="mb-3">
        ...
        <form action="<?php echo URLROOT; ?>/facture/add" method="post">
            <div class="form-group" >
                ...
                <div class="mb-3">
                    <input type="submit" class="btn btn-outline-secondary d-inline-flex align-items-center" value="Ajouter">
                    <a href="<?php echo URLROOT; ?>/facture/index" class="btn btn-outline-secondary d-inline-flex align-items-center"><i class="fa fa-backward" aria-hidden="true"></i> Retour</a>
                </div>
            </div>
        </form>
      </div>
