...
<div class="mt-3">
  <div class="row mb-3">
    <div class="mb-3">
      <h1>Clients :
        <a class="btn btn-outline-secondary d-inline-flex align-items-center" href="<?php echo URLROOT; ?>/facture/add"
          style=" font-size: 20px;"><i class="fa fa-pencil" aria-hidden="true"></i> Ajouter</a>
      </h1>
    </div>
              ...
              <tr>
                ...
                <td scope="row ">
                  <a class="btn btn-outline-secondary"
                    href="<?php echo URLROOT; ?>/facture/edit/<?php echo $facture->id; ?>">
                    <i class="fa fa-pencil" aria-hidden="true"></i> Modifier
                  </a>
                  <a href="#" class="btn btn-outline-danger"
                    onclick="event.preventDefault(); document.getElementById('delete-form-<?php echo $facture->id; ?>').submit();">
                    <i class="fa fa-pencil" aria-hidden="true"></i> Supprimer
                  </a>

                  <form id="delete-form-<?php echo $facture->id; ?>"
                    action="<?php echo URLROOT; ?>/facture/delete/<?php echo $facture->id; ?>" method="POST"
                    style="display: none;">
                  </form>
