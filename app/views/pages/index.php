            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="hero-content" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <h1 class="mb-4">
                            <span class="typed" data-typed-items="Master English, Speak English, With Confidence, Learn English Today">Master English</span>
                        ...
                        <div class="hero-buttons">
                            <a href="<?php echo URLROOT ?>/courses" class="btn btn-primary me-0 me-sm-2 mx-1">Get Started</a>
                            <a href="<?php echo URLROOT ?>" class="btn btn-link mt-2 mt-sm-0 glightbox">
